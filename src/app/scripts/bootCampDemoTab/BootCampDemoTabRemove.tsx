...
export interface IBootCampDemoTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IBootCampDemoTabRemoveProps {

}

/**
 * Implementation of BootCamp Demo remove page
 */
export class BootCampDemoTabRemove  extends TeamsBaseComponent<IBootCampDemoTabRemoveProps, IBootCampDemoTabRemoveState> {
